...
I have created a custom Helm chart that pulls the Docker image from Docker Hub and deploys it using the Helm provider in Terraform on local k3d cluster with one replica and this deployment is automated in the github workflow file at the deploy stage
